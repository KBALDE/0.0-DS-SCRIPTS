...
def main():
    ...
    reg=Regressions(target_type=target_type)
    ...
    # train
    # include cond for FT
    reg.train(train_dict, val_dict, fine_tune=False)
    
    # save the model
    _=joblib.dump(reg.model, model_filename, compress=True)
