...
class RandomForest:
    def __init__(self, target_type='BIN'):
        ...
        self.space = {'n_estimators' : [100, 300, 500, 800, 1200],
        ...
        if target_type=='BIN':
            ...
            self.model = RandomForestRegressor(n_estimators=100, criterion='mse', max_depth=None,
                                               min_samples_split=2,
                                               min_samples_leaf=1, min_weight_fraction_leaf=0.0, 
                                               max_features='sqrt',
                                               max_leaf_nodes=None, min_impurity_decrease=0.0, bootstrap=True,
...
def main():
    ...
    rf=RandomForest(target_type=target_type)
    ...
    # train
    # include cond for FT
    rf.train(train_dict, val_dict, fine_tune=False)
    
    # save the model
    _=joblib.dump(rf.model, model_filename, compress=True)
